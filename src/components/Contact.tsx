  ...
  const contactMethods = [
    {
      ...
      action: 'https://discord.gg/tacops-chile',
  ...
  const installationSteps = [
    {
      ...
      description: 'Descarga Tactical Ops 3.5 desde el enlace oficial',
      details: [
        'Visita el sitio web oficial de Tactical Ops',
        'Busca la sección de descargas',
        'Descarga la versión 3.5 completa (aproximadamente 800MB)',
    ...
    },
    {
      ...
      description: 'Instala el juego base en tu sistema',
      details: [
        'Ejecuta el instalador como administrador',
        'Acepta los términos y condiciones',
        'Selecciona la carpeta de instalación (recomendado: C:\\Games\\TacticalOps)',
    ...
    },
    {
      ...
      description: 'Configura el juego para un rendimiento óptimo',
      details: [
        'Ejecuta el juego por primera vez',
        'Configura la resolución de pantalla',
        'Ajusta la configuración gráfica según tu hardware',
        'Configura los controles a tu preferencia'
      ],
      icon: Monitor
    },
    {
      step: 4,
      title: 'Conexión Multijugador',
      description: 'Conéctate a nuestros servidores',
      details: [
        'Ve a Multijugador en el menú principal',
        'Busca servidores o conecta directamente con la IP',
        ...
        {currentSection === 'installation' && (
          <div>
            <div className="mb-8">
              ...
              <p className="text-blue-200 text-lg">Instrucciones paso a paso para instalar Tactical Ops 3.5</p>
            </div>

            <div className="mb-8 bg-slate-800/40 backdrop-blur-lg rounded-2xl border border-blue-700/30 p-6">
              <h2 className="text-xl font-bold text-white mb-4">Requisitos del Sistema</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-blue-300 font-semibold mb-3">Mínimos</h3>
                  <ul className="text-blue-200 space-y-1 text-sm">
                    <li>• Windows XP SP3 o superior</li>
                    <li>• 512 MB de RAM</li>
                    <li>• DirectX 9.0c compatible</li>
                    <li>• 2 GB de espacio libre</li>
                    <li>• Conexión a internet</li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-green-300 font-semibold mb-3">Recomendados</h3>
                  <ul className="text-blue-200 space-y-1 text-sm">
                    <li>• Windows 10/11</li>
                    <li>• 2 GB de RAM</li>
                    <li>• Tarjeta gráfica dedicada</li>
                    <li>• 4 GB de espacio libre</li>
                    <li>• Conexión banda ancha</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 bg-blue-600/10 border border-blue-500/30 rounded-2xl p-6">
              ...
              <p className="text-blue-200 mb-4">
                Si tienes problemas durante la instalación, no dudes en contactarnos a través de Discord.
              </p>
              <button
                onClick={() => setCurrentSection('main')}
                  ...
                  >
                    ...
                    {method.isInternal ? (
                      <button
                        ...
                        className="flex items-center space-x-1 px-3 py-2 bg-blue-600/20 hover:bg-blue-600/30 rounded-lg text-blue-300 hover:text-blue-200 text-sm font-medium transition-all duration-300"
                      >
          ...
          <div className="bg-slate-800/40 backdrop-blur-lg rounded-2xl border border-blue-700/30 p-6 shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white font-medium">Tactical Ops 3.5</span>
              </div>
            </div>
          </div>
        </div>

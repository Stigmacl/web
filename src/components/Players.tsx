...
const Players: React.FC = () => {
  ...
  const filteredUsers = users.filter(userItem => {
    ...
    const matchesClan = clanFilter === 'all' || userItem.clan === clanFilter;
                ...
                <div className="space-y-3">
                  ...
                  {leader && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center space-x-2">
                        <img
                          src={leader.avatar || 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=24&h=24&fit=crop'}
                          alt={leader.username}

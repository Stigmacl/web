...
type AdminSection = 'overview' | 'users' | 'news' | 'clans' | 'banner' | 'tournaments' | 'maps' | 'moderation' | 'player-stats' | 'streaming' | 'sponsors' | 'servers';
...
const Admin: React.FC = () => {
  ...
  const adminSections = [
    ...
    { id: 'servers' as AdminSection, label: 'Servidores', icon: Database, color: 'text-cyan-400' },

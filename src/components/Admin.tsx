...
import { Settings, Users, FileText, Monitor, MessageCircle, Trophy, Database, Shield, Crown, Star, Zap, Target, Plus, Edit, Trash2, Save, X, Eye, EyeOff, UserCheck, UserX, RotateCcw, AlertTriangle, CheckCircle, Image, Key, UserCog } from 'lucide-react';
...
type AdminSection = 'overview' | 'users' | 'news' | 'clans' | 'banner' | 'tournaments' | 'moderation';

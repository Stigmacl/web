...
try {
    ...
    $query = "SELECT id, username, email, role, avatar, status, clan, is_active, hide_email, player_name
              FROM users
    ...
    // Actualizar último acceso y asegurar que is_online esté en 1
    $updateQuery = "UPDATE users SET last_login = NOW(), is_online = 1 WHERE id = :id";

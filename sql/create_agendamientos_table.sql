...
CREATE TABLE IF NOT EXISTS tbl_agendamientos (
    ...
    supervisor                  VARCHAR(255) COMMENT 'Supervisor responsable (vinculado a tbl_dotacion)',
    ...
    FOREIGN KEY (supervisor) REFERENCES tbl_dotacion(supervisor_asignado) ON DELETE SET NULL
